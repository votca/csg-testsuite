...
~/src/csg/src/tools/csg_resample --in resample.in --out resampled --grid 0:0.1:3 || test_fail
diff resampled resampled.ref || test_fail
test_end

test_start "csg_resample: fitting"
~/src/csg/src/tools/csg_resample --in resampled --out fitted --grid 0:0.1:3 --spfit 0:1:3 || test_fail
